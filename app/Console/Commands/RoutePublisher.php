...
class RoutePublisher extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'routes:api-generate';
     ...
     * @var string
     */
    protected $description = 'Autogenerate api routes';
    ...
    public $routesFilePath = 'routes/api.php';
